...
Ультимативное решение для обхода блокировок Telegram через "партизанский" прокси. Скрипт маскирует трафик под обычные сайты (Habr, Wikipedia, РБК), работает через Docker с автозапуском и управляется одной короткой командой.
...
```bash
wget -qO- [https://raw.githubusercontent.com/anten-ka/gotelegram_mtproxy/main/setup_gotelegram.sh](https://raw.githubusercontent.com/anten-ka/gotelegram_mtproxy/main/setup_gotelegram.sh) | sudo bash
